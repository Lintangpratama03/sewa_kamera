<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Kelola Pelanggan Aktif</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>">Home</a></li>
                        <li class="breadcrumb-item active">Kelola Pelanggan Aktif</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="card">
            <h5 class="card-header">Kelola Pelanggan Aktif</h5>
            <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-start">
                ...
                <div class="col-lg-4">
                    <button type="button" id="btn-ubah" onclick="edit_data()" class="btn btn-outline-warning btn-block">Edit</button>
                </div>
            </div>
        </div>
    </div>
