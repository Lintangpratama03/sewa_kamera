...
class Manage_mitra_admin extends CI_Controller
{
    var $module_js = ['manage-mitra-admin'];
    var $app_data = [];
    ...
    public function index()
    {
        ...
        $this->load->view('menu-admin/manage_mitra');
    ...
    public function konfirmasi_data()
    {
        ...
        $data = array(
            'is_aktif' => '1',
            'konfirmasi_date' => $timestamp,
            'konfirmasi_by' => $data['user']['id'],
        );
        $where = array('id' => $id);
        ...
        if ($updated) {
            $response['success'] = "<script>$(document).ready(function () {
                ...
                Toast.fire({
                    icon: 'success',
                    title: 'Anda telah melakukan konfirmasi akun pelanggan'
                  })
              });</script>";
        }
        echo json_encode($response);
    ...
    public function tolak_data()
    {
        ...
        if ($updated) {
            $response['success'] = "<script>$(document).ready(function () {
                ...
                Toast.fire({
                    icon: 'success',
                    title: 'Anda telah melakukan penolakan akun pelanggan'
                  })
              });</script>";
        }
        echo json_encode($response);
